...
public class FuzzyEngine
{
	...
	private final int EXECUTION = 502;
        ...
        ////////////////////////////////
        // added by Meghna Babbar, Aug 2004
        ////////////////////////////////
        // List of input linguistic variables
        List inputLinguisticVar = new ArrayList();
        // List of output linguistic variables
        List outputLinguisticVar = new ArrayList();
        // Fuzzy Rules and Fuzzy Block of rules.
	...
	private boolean flagRuleFired = false;
        ...
        {
                        fuzzyBlockOfRules = block;
                        fuzzyBlockOfRules.setFuzzyEngine(this);
        ...
        //////////////////////////
        // added by Meghna Babbar, Aug 2004
        public List getInputLinguisticVariablesList (){
            return inputLinguisticVar;
        }

        public void setInputLinguisticVariablesList (List lvList){
            inputLinguisticVar = lvList;
        }

        public List getOutputLinguisticVariables (){
            return outputLinguisticVar;
        }

        public void setOutputLinguisticVariablesList (List lvList){
            outputLinguisticVar = lvList;
        }

        public FuzzyBlockOfRules getFuzzyBlockOfRules (){
            return fuzzyBlockOfRules;
        }

        public void setFuzzyBlockOfRules (FuzzyBlockOfRules fbRules){
            fuzzyBlockOfRules = fbRules;
        }
