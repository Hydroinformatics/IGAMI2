 ...
 * @version 1.0
 */
public class NSGA2Event extends EventObject implements Serializable{
    ...
    */
   public NSGA2Event(Object source, LinkedList<Individual> bestIndividuals, int numberGeneration) {
      super(source);
