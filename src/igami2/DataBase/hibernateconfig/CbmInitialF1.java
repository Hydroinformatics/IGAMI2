...
/**
 * CbmInitialF1 generated by hbm2java
 */
@Entity
public class CbmInitialF1  implements java.io.Serializable {


    @EmbeddedId
     private CbmInitialF1Id id;
     private Double s0;
     private Double s1;
     private Double s2;
     private Double s3;
    ...
    public CbmInitialF1Id getId() {
        return this.id;
    }
    
    public void setId(CbmInitialF1Id id) {
        this.id = id;
    }
    public Double getS0() {
        return this.s0;
