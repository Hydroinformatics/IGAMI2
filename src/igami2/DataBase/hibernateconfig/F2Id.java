...
/**
 * F2Id generated by hbm2java
 */
@Embeddable
public class F2Id  implements java.io.Serializable {
    ...
    public F2Id(int userid, int searchid, long indvid) {
       this.userid = userid;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof F2Id) ) return false;
		 F2Id castOther = ( F2Id ) other; 
