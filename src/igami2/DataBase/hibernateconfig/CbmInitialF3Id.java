...
/**
 * CbmInitialF3Id generated by hbm2java
 */
public class CbmInitialF3Id  implements java.io.Serializable {
    ...
    public CbmInitialF3Id() {
    }

    public CbmInitialF3Id(byte tenureType, int bmpid, int indvid) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof CbmInitialF3Id) ) return false;
		 CbmInitialF3Id castOther = ( CbmInitialF3Id ) other; 
