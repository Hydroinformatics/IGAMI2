...
/**
 * BiasindvdataId generated by hbm2java
 */
@Embeddable
public class BiasindvdataId  implements java.io.Serializable {
    ...
    public BiasindvdataId() {
    }

    public BiasindvdataId(int userid, int searchid, int globalSessionid, int localSessionid, int sessionid, byte sessionType, int indvCount) {
       this.userid = userid;
    ...
    public int getIndvCount() {
        return this.indvCount;
    }
    
    public void setIndvCount(int indvCount) {
        this.indvCount = indvCount;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof BiasindvdataId) ) return false;
		 BiasindvdataId castOther = ( BiasindvdataId ) other; 
 ...
 && (this.getIndvCount()==castOther.getIndvCount());
   }
   ...
   public int hashCode() {
         ...
         result = 37 * result + this.getIndvCount();
         return result;
   }   
