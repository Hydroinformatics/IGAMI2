...
/**
 * CbmInitialF5Id generated by hbm2java
 */
public class CbmInitialF5Id  implements java.io.Serializable {
    ...
    public CbmInitialF5Id() {
    }

    public CbmInitialF5Id(byte tenureType, int bmpid, int indvid) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof CbmInitialF5Id) ) return false;
		 CbmInitialF5Id castOther = ( CbmInitialF5Id ) other; 
