...
/**
 * CbmInitialF6Id generated by hbm2java
 */
@Embeddable
public class CbmInitialF6Id  implements java.io.Serializable {
    ...
    public CbmInitialF6Id() {
    }

    public CbmInitialF6Id(byte tenureType, int bmpid, int indvid) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof CbmInitialF6Id) ) return false;
		 CbmInitialF6Id castOther = ( CbmInitialF6Id ) other; 
