...
/**
 * CbmInitialF6 generated by hbm2java
 */
public class CbmInitialF6  implements java.io.Serializable {


     private CbmInitialF6Id id;
     private Double s0;
     private Double s1;
     private Double s2;
     private Double s3;
    ...
    public CbmInitialF6Id getId() {
        return this.id;
    }
    
    public void setId(CbmInitialF6Id id) {
        this.id = id;
    }
    public Double getS0() {
        return this.s0;
