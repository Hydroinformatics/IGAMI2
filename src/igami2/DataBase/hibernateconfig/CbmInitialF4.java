...
/**
 * CbmInitialF4 generated by hbm2java
 */
public class CbmInitialF4  implements java.io.Serializable {


     private CbmInitialF4Id id;
     private Double s0;
     private Double s1;
     private Double s2;
     private Double s3;
    ...
    public CbmInitialF4Id getId() {
        return this.id;
    }
    
    public void setId(CbmInitialF4Id id) {
        this.id = id;
    }
    public Double getS0() {
        return this.s0;
