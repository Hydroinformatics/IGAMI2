...
/**
 * CbmInitialF4Id generated by hbm2java
 */
@Embeddable
public class CbmInitialF4Id  implements java.io.Serializable {
    ...
    public CbmInitialF4Id() {
    }

    public CbmInitialF4Id(byte tenureType, int bmpid, int indvid) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof CbmInitialF4Id) ) return false;
		 CbmInitialF4Id castOther = ( CbmInitialF4Id ) other; 
