...
/**
 * SdmModellingDataRandomdataId generated by hbm2java
 */
public class SdmModellingDataRandomdataId  implements java.io.Serializable {
    ...
    public SdmModellingDataRandomdataId() {
    }

    public SdmModellingDataRandomdataId(int userid, int searchid, int globalSessionid, int sdmId, int indvid) {
       this.userid = userid;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof SdmModellingDataRandomdataId) ) return false;
		 SdmModellingDataRandomdataId castOther = ( SdmModellingDataRandomdataId ) other; 
