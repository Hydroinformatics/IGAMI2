...
/**
 * CbmId generated by hbm2java
 */
@Embeddable
public class CbmId  implements java.io.Serializable {
    ...
    public CbmId(int userid, int searchid, long indvid, int globalSessionid, int localSessionid, int sessionid, byte sessionType) {
       this.userid = userid;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof CbmId) ) return false;
		 CbmId castOther = ( CbmId ) other; 
