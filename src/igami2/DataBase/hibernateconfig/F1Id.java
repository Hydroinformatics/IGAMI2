...
/**
 * F1Id generated by hbm2java
 */
@Embeddable
public class F1Id  implements java.io.Serializable {
    ...
    public F1Id(int userid, int searchid, long indvid) {
       this.userid = userid;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof F1Id) ) return false;
		 F1Id castOther = ( F1Id ) other; 
