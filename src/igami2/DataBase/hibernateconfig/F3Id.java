...
/**
 * F3Id generated by hbm2java
 */
public class F3Id  implements java.io.Serializable {
    ...
    public F3Id(int userid, int searchid, long indvid) {
       this.userid = userid;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof F3Id) ) return false;
		 F3Id castOther = ( F3Id ) other; 
