...
/**
 * CbmInitialF3 generated by hbm2java
 */
@Entity
public class CbmInitialF3  implements java.io.Serializable {


    @EmbeddedId
     private CbmInitialF3Id id;
     private Double s0;
     private Double s1;
     private Double s2;
     private Double s3;
    ...
    public CbmInitialF3Id getId() {
        return this.id;
    }
    
    public void setId(CbmInitialF3Id id) {
        this.id = id;
    }
    public Double getS0() {
        return this.s0;
