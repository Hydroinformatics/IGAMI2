...
/**
 * SdmModellingDataId generated by hbm2java
 */
public class SdmModellingDataId  implements java.io.Serializable {
    ...
    public SdmModellingDataId() {
    }

    public SdmModellingDataId(int userid, int searchid, int globalSessionid, int sdmId, int indvid) {
       this.userid = userid;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof SdmModellingDataId) ) return false;
		 SdmModellingDataId castOther = ( SdmModellingDataId ) other; 
