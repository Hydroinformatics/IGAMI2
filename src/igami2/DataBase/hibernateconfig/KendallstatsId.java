...
/**
 * KendallstatsId generated by hbm2java
 */
public class KendallstatsId  implements java.io.Serializable {
    ...
    public KendallstatsId() {
    }

    public KendallstatsId(int userid, int searchid, int globalSessionid, int localSessionid) {
       this.userid = userid;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof KendallstatsId) ) return false;
		 KendallstatsId castOther = ( KendallstatsId ) other; 
