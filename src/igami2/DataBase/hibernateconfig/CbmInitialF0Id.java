...
/**
 * CbmInitialF0Id generated by hbm2java
 */
public class CbmInitialF0Id  implements java.io.Serializable {
    ...
    public CbmInitialF0Id() {
    }

    public CbmInitialF0Id(byte tenureType, int bmpid, int indvid) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof CbmInitialF0Id) ) return false;
		 CbmInitialF0Id castOther = ( CbmInitialF0Id ) other; 
