...
/**
 * CbmInitialF5 generated by hbm2java
 */
@Entity
public class CbmInitialF5  implements java.io.Serializable {


    @EmbeddedId
     private CbmInitialF5Id id;
     private Double s0;
     private Double s1;
     private Double s2;
     private Double s3;
    ...
    public CbmInitialF5Id getId() {
        return this.id;
    }
    
    public void setId(CbmInitialF5Id id) {
        this.id = id;
    }
    public Double getS0() {
        return this.s0;
